...
function InvoiceCancelled($vars) {
    ...
    // variaveis template
    $template = Capsule::table('sr_templates_for_whmcs')->where('messageType', 'Fatura Cancelada')->where('type', 'CLIENTE')->first();
    ...
    sendWhatsappMessage ($message, $phone, 'Fatura Cancelada', $clientId);
}
